...
class LoggerProvider:
    def __init__(self):
        ...
        self._root = logging.getLogger("lgr")
        self.loggers: dict[str, _Logger] = {
            "lgr": _Logger(self._root),
        }
        self.fork("login")
        self.fork("network")
        self.fork("utils")
    ...
    def root(self) -> _Logger:
        return self.loggers["lgr"]

    @property
    def network(self) -> _Logger:
        return self.loggers["lgr.network"]

    @property
    def utils(self) -> _Logger:
        return self.loggers["lgr.utils"]

    @property
    def login(self) -> _Logger:
        return self.loggers["lgr.login"]
